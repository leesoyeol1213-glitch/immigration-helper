...
const TEXTS = {
  ko: {
    ...
    disclaimerText:
      "본 서비스는 서류 작성을 돕는 정보 제공 도구입니다. 최종 제출 전 반드시 관계 기관의 안내를 확인하시기 바라며, 서류 제출 및 승인 책임은 본인에게 있습니다.",
  },
  en: {
    flag: "🇺🇸",
    name: "English",
    badge: "Korean Admin Form Helper",
    heroLine1: "Korean paperwork,",
    heroLine2: "done in 3 minutes",
    subLine1: "From E-9 visa extension to required document guides",
    subLine2: "Simplify complex immigration paperwork",
    cta: "Get Started →",
    stat1Value: "3 min",
    stat1Label: "Average time",
    stat2Value: "9",
    ...
    disclaimerText:
      "This service is an information tool to help with form preparation. Please verify with official authorities before submission. The applicant bears full responsibility for submission and approval.",
  },
  vi: {
    flag: "🇻🇳",
    name: "Tiếng Việt",
    badge: "Hỗ trợ giấy tờ hành chính Hàn Quốc",
    heroLine1: "Giấy tờ Hàn Quốc,",
    heroLine2: "hoàn thành trong 3 phút",
    subLine1: "Từ gia hạn visa E-9 đến hướng dẫn giấy tờ cần thiết",
    subLine2: "Đơn giản hóa thủ tục xuất nhập cảnh phức tạp",
    cta: "Bắt đầu ngay →",
    stat1Value: "3 phút",
    stat1Label: "Thời gian",
    stat2Value: "9",
    stat2Label: "Ngôn ngữ",
    stat3Value: "Miễn phí",
    stat3Label: "Miễn phí mãi mãi",
    disclaimerTitle: "⚠️ Lưu ý:",
    disclaimerText:
      "Dịch vụ này là công cụ thông tin hỗ trợ chuẩn bị giấy tờ. Vui lòng xác minh với cơ quan có thẩm quyền trước khi nộp. Người nộp đơn chịu toàn bộ trách nhiệm về việc nộp và phê duyệt.",
  },
};

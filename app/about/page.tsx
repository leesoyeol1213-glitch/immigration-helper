...
const TEXTS: Record<Lang, any> = {
  ko: {
    ...
    chungbukTitle: "📊 충북 외국인 현황 (출처: 충청북도·법무부)",
    chungbukStats: [
      { value: "56,301명", label: "충북 등록외국인", subLabel: "전체 인구의 3.4%" },
      { value: "11개 시군", label: "전 지역 분포", subLabel: "청주~단양" },
      { value: "청주 19,300명", label: "외국인 최다", subLabel: "도내 1위" },
      { value: "음성 13,808명", label: "2위 (제조업)", subLabel: "인구감소관심지역" },
      { value: "진천 8,419명", label: "3위 (제조업)", subLabel: "본 서비스 베타 지역" },
      { value: "87%", label: "제조업 종사", subLabel: "한국고용정보원 2026" },
    ],
    chungbukInsight: "💡 충북 등록외국인 56,301명, 그중 87%가 제조업 — 우리의 핵심 타겟",
